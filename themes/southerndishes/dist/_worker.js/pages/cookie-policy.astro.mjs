...
const $$CookiePolicy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    if (Astro2.locals.runtime?.env?.DB) {
      page = await db.getPageBySlug("cookie-policy");
...
}, "/Users/anjani/Desktop/cheftaling/src/pages/cookie-policy.astro", void 0);

const $$file = "/Users/anjani/Desktop/cheftaling/src/pages/cookie-policy.astro";
