...
const $$Disclaimer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    if (Astro2.locals.runtime?.env?.DB) {
      page = await db.getPageBySlug("disclaimer");
...
}, "/Users/anjani/Desktop/cheftaling/src/pages/disclaimer.astro", void 0);

const $$file = "/Users/anjani/Desktop/cheftaling/src/pages/disclaimer.astro";
