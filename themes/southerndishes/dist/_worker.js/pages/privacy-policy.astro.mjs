...
const $$PrivacyPolicy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    if (Astro2.locals.runtime?.env?.DB) {
      page = await db.getPageBySlug("privacy-policy");
...
}, "/Users/anjani/Desktop/cheftaling/src/pages/privacy-policy.astro", void 0);

const $$file = "/Users/anjani/Desktop/cheftaling/src/pages/privacy-policy.astro";
