...
const $$GdprPolicy = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GdprPolicy;
  const db = new DatabaseService(Astro2.locals.runtime?.env?.DB || {});
  let page;
  let settings = {};
  try {
    if (Astro2.locals.runtime?.env?.DB) {
      page = await db.getPageBySlug("gdpr-policy");
...
}, "/Users/anjani/Desktop/cheftaling/src/pages/gdpr-policy.astro", void 0);

const $$file = "/Users/anjani/Desktop/cheftaling/src/pages/gdpr-policy.astro";
const $$url = "/gdpr-policy";
