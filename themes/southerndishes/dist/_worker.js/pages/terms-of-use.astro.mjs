...
const $$TermsOfUse = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    if (Astro2.locals.runtime?.env?.DB) {
      page = await db.getPageBySlug("terms-of-use");
...
}, "/Users/anjani/Desktop/cheftaling/src/pages/terms-of-use.astro", void 0);

const $$file = "/Users/anjani/Desktop/cheftaling/src/pages/terms-of-use.astro";
