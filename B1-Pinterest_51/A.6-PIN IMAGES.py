...
if __name__ == "__main__":
    ...
    output_dir = "../ALL/B1-Pinterest_51-out/output_images"
    ...
    line_spacing = 17
    jpeg_quality = 70
    excel_file = "../ALL/B1-Pinterest_51-out/images.xlsx"
    output_excel_file = "../ALL/B1-Pinterest_51-out/images.xlsx"
    ...
    for idx, row in df.iterrows():
        url_img1 = row.get('image_3')
        url_img2 = row.get('image_4')
